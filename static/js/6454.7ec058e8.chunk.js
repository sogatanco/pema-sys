...
to {
  ...
  animation: ${U} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,J=e=>{let{toast:t}=e,{icon:r,type:a,iconTheme:s}=t;return void 0!==r?"string"==typeof r?n.createElement(V,null,r):r:"blank"===a?null:n.createElement(K,null,n.createElement(B,{...s}),"loading"!==a&&n.createElement(q,null,"error"===a?n.createElement(A,{...s}):n.createElement(H,{...s})))},Q=e=>`\n0% {transform: translate3d(0,${-200*e}%,0) scale(.6); opacity:.5;}\n100% {transform: translate3d(0,0,0) scale(1); opacity:1;}\n`,Y=e=>`\n0% {transform: translate3d(0,0,-1px) scale(1); opacity:1;}\n100% {transform: translate3d(0,${-150*e}%,-1px) scale(.6); opacity:0;}\n`,G=x("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
